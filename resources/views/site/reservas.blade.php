...
<body>
    ...
    <form action="{{ route('reservas_store') }}" id="reserva-form" method="POST" class="form-container">
        ...
        <p class="form-description">Únete a disfrutar ingresando la información de tu viaje para disfrutar de una experiencia única en Quibdó.</p>
        ...
        <fieldset class="form-group">
            ...
            <label>
                <input type="checkbox" name="transporte" value="1"> Transporte incluido
            </label>
            <br>
            <label>
                <input type="checkbox" name="hospedaje" value="1"> Hospedaje incluido
            </label>
            <br>
            <label>
                <input type="checkbox" name="alimentacion" value="1"> Alimentación incluida
            </label>
        </fieldset>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <p style="font-family: 'text';" id="modal-message"></p>
        </div>
    </div>
